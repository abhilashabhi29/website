...
const WORKS = [
  ...
  },
 {
  ...
  // ---------------- MAGAZINE ----------------
  {
    id: "mag-1",
    category: "magazine",
    title: "ଆସ୍ପୃହା (Aspruha) — August 2026",
    year: "2026",
    publisher: "Aspruha Magazine",
    shortDesc: "An issue of Aspruha, edited and compiled by Shantilata Pradhan. This excerpt features \"Purna Yoga O Tantra\" (Integral Yoga and Tantra) by Dr. Gayadhar Das, a retired professor from Kendujhar. [DESCRIPTION — add more about this issue if you'd like.]",
    longDesc: "Edited and compiled by Shantilata Pradhan. This issue includes \"ପୂର୍ଣ୍ଣଯୋଗ ଓ ତନ୍ତ୍ର\" (Purna Yoga O Tantra — Integral Yoga and Tantra), an article by Dr. Gayadhar Das, a retired professor from Kendujhar, drawing on Sri Aurobindo's Synthesis of Yoga and related writings on Tantra.\n\n[FULL DESCRIPTION — add more about Aspruha magazine's scope, mission, or this particular issue's other contents.]",
    coverTone: 3,
    featured: true,
    linkLabel: "[READ ISSUE]",
    linkUrl: "#",
    pdfFile: "pdfs/mag-1.pdf",
    coverImage: "covers/mag-1.jpg"
  },
  {
    id: "mag-2",
    category: "magazine",
